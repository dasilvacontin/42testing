...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2014/08/06 22:12:57 by dda-silv          #+#    #+#             */
/*   Updated: 2014/08/06 22:12:59 by dda-silv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(void)
{
	...
	ft_add_test_case(&data[3][0], "ASFPHASHOF", "1");
	...
	while (i < TEST_CASES)
	{
		...
		time(&start_t);
		your_result = ft_str_is_uppercase(original);
		time(&end_t);
