...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2014/08/06 22:16:19 by dda-silv          #+#    #+#             */
/*   Updated: 2014/08/06 22:16:20 by dda-silv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(void)
{
	...
	ft_add_test_case(&data[0][0], "asi;yabs;fj", "1");
	ft_add_test_case(&data[1][0], "23\x01\x02\x03\x04UMA 346DBRO", "0");
	ft_add_test_case(&data[2][0], "", "1");
	ft_add_test_case(&data[3][0], "ASFPHA \x7Fw0l0l0 SHOF", "0");
	...
	while (i < TEST_CASES)
	{
		...
		time(&start_t);
		your_result = ft_str_is_printable(original);
		time(&end_t);
