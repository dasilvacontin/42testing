...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2014/08/06 22:04:39 by dda-silv          #+#    #+#             */
/*   Updated: 2014/08/06 22:04:40 by dda-silv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(void)
{
	...
	ft_add_test_case(&data[1][0], "235UMA346DBRO", "0");
	ft_add_test_case(&data[2][0], "", "1");
	ft_add_test_case(&data[3][0], "351706", "1");
	...
	while (i < TEST_CASES)
	{
		...
		time(&start_t);
		your_result = ft_str_is_numeric(original);
		time(&end_t);
